...
A token is used for authorizing a user to access routes/resources that are permitted with that token.
- [ ] What steps can you take in your web apps to keep your data secure?
Use protected routes, JWTs, and salt/hash passwords.
- [ ] Describe how web servers work.
A physical machine running a web server such as NGINX hosts your website. The server can take incoming requests to serve the website to clients.
